...
void _exerciseSerialize(
  ...
  writer.writeByte(offsets[1], object.equipment.index);
  writer.writeString(offsets[2], object.imageUrl);
  writer.writeStringList(offsets[3], object.muscleGroups);
  writer.writeString(offsets[4], object.name);
  writer.writeString(offsets[5], object.primaryMuscle);
  writer.writeByte(offsets[6], object.pushPullType.index);
}
...
Exercise _exerciseDeserialize(
  ...
  object.equipment =
      _ExerciseequipmentValueEnumMap[reader.readByteOrNull(offsets[1])] ??
          EquipmentType.barbell;
  object.id = id;
  object.imageUrl = reader.readStringOrNull(offsets[2]);
  object.muscleGroups = reader.readStringList(offsets[3]) ?? [];
  object.name = reader.readString(offsets[4]);
  object.primaryMuscle = reader.readString(offsets[5]);
  object.pushPullType =
      _ExercisepushPullTypeValueEnumMap[reader.readByteOrNull(offsets[6])] ??
          PushPullType.push;
  return object;
}
