...
class _BmiRmrPageState extends State<BmiRmrPage> {
  ...
  Future<void> _calculate() async {
    ...
    if (profile == null || profile.heightIn == null || profile.age == null) {
      setState(() {
        _errorMessage = "Please complete your height, gender, and birthday in the 'Profile' tab.";
      });
      return;
    }
            ...
            if (_bmi != null && _rmr != null)
              Column(
                children: [
                  ...
                  Text(_bmi!.toStringAsFixed(1), style: Theme.of(context).textTheme.displayLarge),
                  const SizedBox(height: 32),
                  Text('Your Resting Metabolic Rate (RMR)', style: Theme.of(context).textTheme.titleMedium),
                  Text('${_rmr!.round()} kcal/day', style: Theme.of(context).textTheme.displayLarge),
