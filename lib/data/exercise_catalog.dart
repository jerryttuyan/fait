...
final List<Exercise> defaultExercises = [
  ...
  Exercise()
    ...
    ..muscleGroups = [MuscleGroup.chest.name, MuscleGroup.triceps.name, MuscleGroup.shoulders.name]
    ..primaryMuscle = 'Pectoralis Major'
    ..pushPullType = PushPullType.push
    ..equipment = EquipmentType.barbell,
  Exercise()
    ..name = 'Incline Barbell Press'
    ..muscleGroups = [MuscleGroup.chest.name, MuscleGroup.shoulders.name, MuscleGroup.triceps.name]
  ...
  Exercise()
    ...
    ..muscleGroups = [MuscleGroup.quadriceps.name, MuscleGroup.glutes.name, MuscleGroup.lowerBack.name]
  ...
  Exercise()
    ...
    ..muscleGroups = [MuscleGroup.hamstrings.name, MuscleGroup.glutes.name, MuscleGroup.lowerBack.name]
  ...
  Exercise()
    ..name = 'Clean and Jerk'
    ..muscleGroups = [MuscleGroup.chest.name, MuscleGroup.back.name, MuscleGroup.shoulders.name, MuscleGroup.glutes.name, MuscleGroup.hamstrings.name, MuscleGroup.quadriceps.name, MuscleGroup.lowerBack.name]
